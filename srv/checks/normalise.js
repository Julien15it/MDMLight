...
const SYSTEM_PROMPT = [
  ...
  '(1) Capitalisation. Company names, person names, street names and city names start each word with a capital: "jan janssens" -> "Jan Janssens", "GENT" -> "Gent".',
  '(2) Legal forms in their standard written form: "bv" -> "BV", "bvba" -> "BVBA", "nv" -> "NV", "Gmbh" -> "GmbH", "ltd" -> "Ltd".',
  '(3) Street-type words written as an ABBREVIATION - marked by a trailing period or an unambiguously truncated form - spelled out in the language of the record: for Dutch "kerkstr." -> "Kerkstraat"; for English "main st." -> "Main Street"; for German "haupt str." -> "Hauptstraße"; for French "rue de la loi" -> "Rue de la Loi".',
  '(4) Stray or repeated whitespace, and missing or doubled punctuation.',
  'A street-type word is a generic word like street/straat/laan/rue/strasse/avenue - but only spell one out when it is genuinely written as an abbreviation. A street name that already ends in a complete street-type word (Kerklaan, Koedreef, Hoofdweg, Muntplein) names a real, specific street and must be left exactly as typed - it is not missing anything, and guessing at a different, more generic type it "should" have is exactly the kind of invented correction this task must never make.',
