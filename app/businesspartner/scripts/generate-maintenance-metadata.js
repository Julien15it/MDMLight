...
const sections = [
  ...
  },
  {
    ...
    kind: 'collection',
    // Language is ADDR1_DATA-LANGU and S/4 requires it (FSBP_GENERIC/008). AddressTimeZone is
    // derived from country + region. Both off the summary: short codes earn no column beside the
    // street when the row is collapsed.
    fieldNames: [
      'BusinessPartner', 'AddressID', 'StreetName', 'HouseNumber',
      'PostalCode', 'CityName', 'Country', 'Region', 'POBox', 'Language', 'AddressTimeZone'
    ],
    summaryFields: [
